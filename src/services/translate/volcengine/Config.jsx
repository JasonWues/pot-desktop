        ...
        config !== null && (
            ...
            >
                ...
                <div className={'config-item'}>
                    ...
                    >
                        <Label className='text-base my-auto'>{t('services.translate.volcengine.appid')}</Label>
                        <Input
                            variant='secondary'
                            className='max-w-[50%]'
                        />
                ...
                <div className={'config-item'}>
                    ...
                    >
                        <Label className='text-base my-auto'>{t('services.translate.volcengine.secret')}</Label>
                        <Input
                            variant='secondary'
                            className='max-w-[50%]'
                        />
