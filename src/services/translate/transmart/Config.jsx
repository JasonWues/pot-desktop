        ...
        config !== null && (
            ...
            >
                ...
                <div className={'config-item'}>
                    ...
                    >
                        <Label className='text-base my-auto'>{t('services.translate.transmart.username')}</Label>
                        <Input
                            variant='secondary'
                            className='max-w-[50%]'
                        />
                ...
                <div className={'config-item'}>
                    ...
                    >
                        <Label className='text-base my-auto'>{t('services.translate.transmart.token')}</Label>
                        <Input
                            variant='secondary'
                            className='max-w-[50%]'
                        />
